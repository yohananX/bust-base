...
# No insecure fallback: an empty SECRET_KEY is refused outright in production
# (see the fail-loud guard below). Development .env files provide a real value.
SECRET_KEY = env('SECRET_KEY', default='')

# Never default to DEBUG=True — a production deploy that forgets the env var
# must fail closed, not expose tracebacks and the debug toolbar surface.
