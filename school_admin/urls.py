...
urlpatterns = [
    ...
    path('fees/pricing/', FeePricingView.as_view(), name='fee_pricing'),
    path('fees/structures/<int:pk>/edit/', FeeStructureEditView.as_view(), name='fee_structure_edit'),
    path('fees/structures/<int:pk>/delete/', FeeStructureDeleteView.as_view(), name='fee_structure_delete'),
